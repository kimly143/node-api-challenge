...
- [x] Describe Middleware?
    It's a function that sit in the middle of the reequest and the handler and it can form a variety of functions that can be use anywhere.

- [x] Describe a Resource?
    Resource represent a logical piece of data. 

- [x] What can the API return to help clients know if a request was successful?
    Status codes to show if the request is success or failure, like 201, 404, 500...
